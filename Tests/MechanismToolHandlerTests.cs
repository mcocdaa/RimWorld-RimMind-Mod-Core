...
namespace RimMind.Presentation.Tests
{
    public class MechanismToolHandlerTests
    {
        ...
        public void Constructor_Query_GeneratesThreeSegmentId()
        {
            ...
            var handler = new MechanismToolHandler(mech, mech, mech, mech, MechanismOperationType.Query, new MechanismToolHelper.FallbackJsonExtractor());
        ...
        public void Constructor_Set_GeneratesThreeSegmentId()
        {
            ...
            var handler = new MechanismToolHandler(mech, mech, mech, mech, MechanismOperationType.Set, new MechanismToolHelper.FallbackJsonExtractor());
        ...
        public void Constructor_List_GeneratesThreeSegmentId()
        {
            ...
            var handler = new MechanismToolHandler(mech, mech, mech, mech, MechanismOperationType.List, new MechanismToolHelper.FallbackJsonExtractor());
