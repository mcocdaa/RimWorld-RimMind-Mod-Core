...
namespace RimMind.Presentation.UI
{
    public static class RimMindCoreSettingsUI
    {
        ...
        // Cached service references (resolved once via RimMindRuntime)
        ...
        private static void DrawApiTab(Rect inRect, ISettingsProvider s)
        {
            ...
            SettingsUIHelper.DrawSectionHeader(listing, "RimMind.Settings.Tab.Api".Translate());
            ...
            SettingsUIHelper.DrawSectionHeader(listing, "RimMind.Settings.Section.ModelBehavior".Translate());
            ...
            SettingsUIHelper.DrawSectionHeader(listing, "RimMind.Settings.Section.Request".Translate());
            ...
            SettingsUIHelper.DrawSectionHeader(listing, "RimMind.Settings.Section.Debug".Translate());
            ...
            SettingsUIHelper.DrawSectionHeader(listing, "RimMind.UI.FlywheelAutoApply".Translate());
            {
                Rect row = listing.GetRect(28f);
        ...
        private static void DrawQueueTab(Rect inRect, ISettingsProvider settings)
        {
            ...
            SettingsUIHelper.DrawSectionHeader(listing, "RimMind.Settings.Queue.Status".Translate());
            ...
            listing.Label($"{"RimMind.Settings.Queue.Active".Translate()}: {activeCount} / {settings.MaxConcurrentRequests}");
            listing.Label($"{"RimMind.Settings.Queue.Queued".Translate()}: {queuedCount}");
            ...
            SettingsUIHelper.DrawSectionHeader(listing, "RimMind.Settings.Queue.PerMod".Translate());
            ...
            SettingsUIHelper.DrawSectionHeader(listing, "RimMind.Settings.Queue.ActiveRequests".Translate());
            ...
            SettingsUIHelper.DrawSectionHeader(listing, "RimMind.Settings.Queue.QueuedRequests".Translate());
        ...
        private static void DrawContextTab(Rect inRect, ISettingsProvider s)
        {
            ...
            SettingsUIHelper.DrawSectionHeader(listing, "RimMind.Context.Presets".Translate());
            ...
            left.CheckboxLabeled("RimMind.Context.IncludeRace".Translate(), ref includeRace, "RimMind.Context.IncludeRace.Desc".Translate());
            ctx.IncludeRace = includeRace;
            var includeAge = ctx.IncludeAge;
            left.CheckboxLabeled("RimMind.Context.IncludeAge".Translate(), ref includeAge, "RimMind.Context.IncludeAge.Desc".Translate());
            ctx.IncludeAge = includeAge;
            var includeGender = ctx.IncludeGender;
            left.CheckboxLabeled("RimMind.Context.IncludeGender".Translate(), ref includeGender, "RimMind.Context.IncludeGender.Desc".Translate());
            ctx.IncludeGender = includeGender;
            var includeBackstory = ctx.IncludeBackstory;
            left.CheckboxLabeled("RimMind.Context.IncludeBackstory".Translate(), ref includeBackstory, "RimMind.Context.IncludeBackstory.Desc".Translate());
            ctx.IncludeBackstory = includeBackstory;
            var includeIdeology = ctx.IncludeIdeology;
            left.CheckboxLabeled("RimMind.Context.IncludeIdeology".Translate(), ref includeIdeology, "RimMind.Context.IncludeIdeology.Desc".Translate());
            ctx.IncludeIdeology = includeIdeology;
            var includeTraits = ctx.IncludeTraits;
            left.CheckboxLabeled("RimMind.Context.IncludeTraits".Translate(), ref includeTraits, "RimMind.Context.IncludeTraits.Desc".Translate());
            ...
            left.CheckboxLabeled("RimMind.Context.IncludeHealth".Translate(), ref includeHealth, "RimMind.Context.IncludeHealth.Desc".Translate());
            ctx.IncludeHealth = includeHealth;
            var includeCapacities = ctx.IncludeCapacities;
            left.CheckboxLabeled("RimMind.Context.IncludeCapacities".Translate(), ref includeCapacities, "RimMind.Context.IncludeCapacities.Desc".Translate());
            ctx.IncludeCapacities = includeCapacities;
            var includeMood = ctx.IncludeMood;
            left.CheckboxLabeled("RimMind.Context.IncludeMood".Translate(), ref includeMood, "RimMind.Context.IncludeMood.Desc".Translate());
            ctx.IncludeMood = includeMood;
            var includeMoodThoughts = ctx.IncludeMoodThoughts;
            left.CheckboxLabeled("RimMind.Context.IncludeMoodThoughts".Translate(), ref includeMoodThoughts, "RimMind.Context.IncludeMoodThoughts.Desc".Translate());
            ctx.IncludeMoodThoughts = includeMoodThoughts;
            var includeCurrentJob = ctx.IncludeCurrentJob;
            left.CheckboxLabeled("RimMind.Context.IncludeCurrentJob".Translate(), ref includeCurrentJob, "RimMind.Context.IncludeCurrentJob.Desc".Translate());
            ctx.IncludeCurrentJob = includeCurrentJob;
            var includeWorkPriorities = ctx.IncludeWorkPriorities;
            left.CheckboxLabeled("RimMind.Context.IncludeWorkPriorities".Translate(), ref includeWorkPriorities, "RimMind.Context.IncludeWorkPriorities.Desc".Translate());
            ctx.IncludeWorkPriorities = includeWorkPriorities;
            var includeEquipment = ctx.IncludeEquipment;
            left.CheckboxLabeled("RimMind.Context.IncludeEquipment".Translate(), ref includeEquipment, "RimMind.Context.IncludeEquipment.Desc".Translate());
            ctx.IncludeEquipment = includeEquipment;
            var includeInventory = ctx.IncludeInventory;
            left.CheckboxLabeled("RimMind.Context.IncludeInventory".Translate(), ref includeInventory, "RimMind.Context.IncludeInventory.Desc".Translate());
            ctx.IncludeInventory = includeInventory;
            var includeLocation = ctx.IncludeLocation;
            left.CheckboxLabeled("RimMind.Context.IncludeLocation".Translate(), ref includeLocation, "RimMind.Context.IncludeLocation.Desc".Translate());
            ctx.IncludeLocation = includeLocation;
            var includeRelations = ctx.IncludeRelations;
            left.CheckboxLabeled("RimMind.Context.IncludeRelations".Translate(), ref includeRelations, "RimMind.Context.IncludeRelations.Desc".Translate());
            ctx.IncludeRelations = includeRelations;
            var includeGenes = ctx.IncludeGenes;
            left.CheckboxLabeled("RimMind.Context.IncludeGenes".Translate(), ref includeGenes, "RimMind.Context.IncludeGenes.Desc".Translate());
            ctx.IncludeGenes = includeGenes;
            var includeCombatStatus = ctx.IncludeCombatStatus;
            left.CheckboxLabeled("RimMind.Context.IncludeCombatStatus".Translate(), ref includeCombatStatus, "RimMind.Context.IncludeCombatStatus.Desc".Translate());
            ctx.IncludeCombatStatus = includeCombatStatus;
            var includeSurroundings = ctx.IncludeSurroundings;
            left.CheckboxLabeled("RimMind.Context.IncludeSurroundings".Translate(), ref includeSurroundings, "RimMind.Context.IncludeSurroundings.Desc".Translate());
            ...
            right.CheckboxLabeled("RimMind.Context.IncludeGameTime".Translate(), ref includeGameTime, "RimMind.Context.IncludeGameTime.Desc".Translate());
            ctx.IncludeGameTime = includeGameTime;
            var includeColonistCount = ctx.IncludeColonistCount;
            right.CheckboxLabeled("RimMind.Context.IncludeColonistCount".Translate(), ref includeColonistCount, "RimMind.Context.IncludeColonistCount.Desc".Translate());
            ctx.IncludeColonistCount = includeColonistCount;
            var includeColonistNames = ctx.IncludeColonistNames;
            right.CheckboxLabeled("RimMind.Context.IncludeColonistNames".Translate(), ref includeColonistNames, "RimMind.Context.IncludeColonistNames.Desc".Translate());
            ctx.IncludeColonistNames = includeColonistNames;
            var includeWealth = ctx.IncludeWealth;
            right.CheckboxLabeled("RimMind.Context.IncludeWealth".Translate(), ref includeWealth, "RimMind.Context.IncludeWealth.Desc".Translate());
            ctx.IncludeWealth = includeWealth;
            var includeFood = ctx.IncludeFood;
            right.CheckboxLabeled("RimMind.Context.IncludeFood".Translate(), ref includeFood, "RimMind.Context.IncludeFood.Desc".Translate());
            ctx.IncludeFood = includeFood;
            var includeSeason = ctx.IncludeSeason;
            right.CheckboxLabeled("RimMind.Context.IncludeSeason".Translate(), ref includeSeason, "RimMind.Context.IncludeSeason.Desc".Translate());
            ctx.IncludeSeason = includeSeason;
            var includeWeather = ctx.IncludeWeather;
            right.CheckboxLabeled("RimMind.Context.IncludeWeather".Translate(), ref includeWeather, "RimMind.Context.IncludeWeather.Desc".Translate());
            ctx.IncludeWeather = includeWeather;
            var includeThreats = ctx.IncludeThreats;
            right.CheckboxLabeled("RimMind.Context.IncludeThreats".Translate(), ref includeThreats, "RimMind.Context.IncludeThreats.Desc".Translate());
            ...
            SettingsUIHelper.DrawSectionHeader(listing, "RimMind.Context.Budget".Translate());
