...
namespace RimMind.Core.ArchTests.PhaseC
{
    public class CoreVerseMigrationTrackerTests
    {
        private static readonly string[] KnownVerseUserFiles = new[]
        {
            ...
            @"Presentation\Agent\PawnAgentFactory.cs",
            @"Presentation\Agent\GameContextBuilder.cs",
            @"Presentation\Agent\PawnDataExtractor.cs",
            @"Presentation\Agent\PawnContextBuilder.cs",
            @"Presentation\Agent\PawnContextBuilder.Extract.cs",
            @"Presentation\Agent\MapContextBuilder.cs",
            @"Presentation\Agent\Models\SerializableAgentIdentity.cs",
            @"Presentation\Agent\Perception\EnvironmentPerceptionSource.cs",
            @"Presentation\Agent\Perception\NeedPerceptionSource.cs",
            @"Presentation\Agent\Perception\SocialPerceptionSource.cs",
            @"Presentation\Agent\Perception\CombatPerceptionSource.cs",
            @"Presentation\Agent\Perception\HealthPerceptionSource.cs",
            @"Presentation\Agent\Perception\MoodPerceptionSource.cs",
            @"Presentation\Agent\Interfaces\IPawnAgentVerse.cs",
            @"Presentation\Agent\Interfaces\IPawnAgentFactoryVerse.cs",
